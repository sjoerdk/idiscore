...
official IDIS Core docs, in docstrings, or even on the web in blog
posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
<https://github.com/sjoerdk/idiscore/issues>.
...
Ready to contribute? Here\'s how to set up [idiscore]{.title-ref} for
local development.

1.  Fork the [idiscore]{.title-ref} repo on GitHub.
...
-   Work via pull requests: clone the idiscore repo, make changes and
    make a pull request

## Code quality

All code must conform to [flake8](https://pypi.org/project/flake8/). And
[black](https://pypi.org/project/black/) Build will fail for
non-conformant code. Either run flake8 and black yourself (in repo root
folder, type [flake8 idiscore tests]{.title-ref}, and \'black .\') or
