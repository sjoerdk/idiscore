...
information from DICOM image data if needed. It processes in accordance to the `DICOM deidentification profile and options <http://dicom.nema.org/medical/dicom/current/output/chtml/part15/chapter_E.html#table_E.1-1>`_
...
Non-Goals
=========
* No Deidentification pipeline. IDIS core deidentifies DICOM datasets. It does want to know where this dataset comes
  from or where it is going to
